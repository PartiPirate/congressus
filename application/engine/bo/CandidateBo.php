...
class CandidateBo {
	...
	function create(&$candidate) {
		$query = "	INSERT INTO ".$this->personaeDatabase."dlp_candidates () VALUES ()	";
...
//				echo showQuery($query, $args);
	...
	function update($candidate) {
		$query = "	UPDATE ".$this->personaeDatabase."dlp_candidates SET ";
...
//		echo showQuery($query, $candidate);
	...
	function getCandidates($filters = null) {
		...
		$query = "	SELECT *
					FROM  ".$this->personaeDatabase."dlp_candidates
					WHERE
						1 = 1 \n";

...
$schema["tables"]["chats"]["fields"]["cha_text"] = array("type" => "text", "null" => false);
$schema["tables"]["chats"]["fields"]["cha_datetime"] = array("type" => "datetime", "null" => false);
...
$schema["tables"]["locations"]["fields"]["loc_channel"] = array("type" => "varchar", "size" => 255, "null" => false);
$schema["tables"]["locations"]["fields"]["loc_extra"] = array("type" => "varchar", "size" => 2048, "null" => false);
...
$schema["tables"]["meetings"]["fields"]["mee_status"] = array("type" => "enum", "size" => "'construction','open','closed','waiting','deleted'", "null" => false, "default" => "construction");
...
$schema["tables"]["meetings"]["fields"]["mee_meeting_type_id"] = array("type" => "bigint", "size" => 20, "null" => false);
...
$schema["tables"]["notices"]["fields"]["not_target_type"] = array("type" => "enum", "size" => "'galette_adherents','galette_groups','dlp_themes','dlp_groups','con_external','all_members','cus_users'", "null" => false);
$schema["tables"]["notices"]["fields"]["not_target_id"] = array("type" => "bigint", "size" => 20, "null" => true);
$schema["tables"]["notices"]["fields"]["not_external_mails"] = array("type" => "varchar", "size" => 2048, "null" => false);
...
$schema["tables"]["pings"]["fields"]["pin_datetime"] = array("type" => "datetime", "null" => false);
